...
def run_spark_job(spark):
    ...
    def foreach_batch_function(dfb, epoch_id):
        dfb.write.format("com.mongodb.spark.sql.DefaultSource")\
            ...
            .option("idFieldList", "disposition,original_crime_type_name")\
...
if __name__ == "__main__":
    ...
    spark = (
        SparkSession.builder \
            .config("spark.mongodb.input.uri","mongodb://dbAdmin:password!1234@10.240.40.43:27117/spark?authSource=spark")\
            .config("spark.mongodb.output.uri","mongodb://dbAdmin:password!1234@10.240.40.43:27117/spark?authSource=spark")\
